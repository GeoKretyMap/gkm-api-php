...
if (isset($_GET['newer'])) $query->bind('newer', $_GET['newer'], 'xs:boolean');
if (isset($_GET['older'])) $query->bind('older', $_GET['older'], 'xs:boolean');
if (isset($_GET['ghosts'])) $query->bind('ghosts', $_GET['ghosts'], 'xs:boolean');
